      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 text-left">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-6xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-4xl xl:text-5xl dark:text-white">
              Welcome to Asa Foundation
            </h1>
            <h3 className="max-w-6xl mb-4 text-4xl font-medium tracking-tight leading-none md:text-2xl xl:text-3xl dark:text-white">
            ...
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              ...
              celebrated for her achievements as a Chartered Accountant and
              Indian Classical dancer. Empowering underprivileged children
              through education, we continue Asa's legacy of compassion and
              support.
            </p>
            <a
              href="#m"
